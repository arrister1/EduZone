  ...
  Widget build(BuildContext context) {
    return Scaffold(body: LayoutBuilder(
      ...
      if (constraints.maxWidth <= 600) {
        return SocialGrid(gridCount: 2);
      } else if (constraints.maxWidth <= 1200) {
        return SocialGrid(gridCount: 4);
      } else {
        return SocialGrid(gridCount: 6);
      }
    }));
  }
}
...
class SocialGrid extends StatelessWidget {
  ...
  const SocialGrid({Key? key, required this.gridCount}) : super(key: key);
      ...
      body: Container(
        child: Padding(
            ...
            child: GridView.count(
              ...
              crossAxisSpacing: 5,
              mainAxisSpacing: 20,
              children: courseSocial.map((course) {
                return InkWell(
                  onTap: () {
